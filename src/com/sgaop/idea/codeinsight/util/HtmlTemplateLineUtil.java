...
public class HtmlTemplateLineUtil {
    ...
    public static List<VirtualFile> findTemplteFileList(PsiElement bindingElement) {
        ...
        Collection<VirtualFile> virtualFiles = FilenameIndex.getAllFilesByExt(bindingElement.getProject(), getFileExtension(path).replaceAll("\\.", ""), GlobalSearchScope.allScope(bindingElement.getProject()));
